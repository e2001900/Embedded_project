...
uint8_t readHoldingRegs (void)
{
	...
	{
		uint32_t floatValue = *((uint32_t*)&Holding_Registers_Database[startAddr]);
		...
		//TxData[indx++] = (Holding_Registers_Database[startAddr])&0xFF;   // extract the lower byte
		  TxData[indx++] = (floatValue >> 24) & 0xFF;
		  TxData[indx++] = (floatValue >> 16) & 0xFF;
		  TxData[indx++] = (floatValue >> 8) & 0xFF;
		  TxData[indx++] = floatValue & 0xFF;
